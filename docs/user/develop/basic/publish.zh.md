...
如果改用全新的源码 checkout，请先完成[开发环境搭建](../../../../docs/development.md#setup-tutorial)，将本教程的 `hello-plugin` 目录放在仓库根目录，并从该目录把下文的 `dsh ...` 命令改为 `pnpm dsh ...`。构建与启动器行为见[源码执行](../../../../apps/cli/reference/README.md#source-execution)。
