...
This guide assumes you started the Web UI with `npx @deepseek-ai/dsh web` (see the [`dsh web` alias](../../../apps/cli/reference/README.md)). Model changes take effect on the next request without restarting the server.
