...
export function GenericToolCard({ toolName, block, cwd, home, openFile, revealFile, inspect, t }: GenericToolCardProps) {
  ...
  return (
    <ToolRow
      ...
      onRevealFile={singleFile ? revealFile : undefined}
      inspect={inspect}
    />
  )
}
