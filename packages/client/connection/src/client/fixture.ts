  ...
  const api: ApiProxy = {
    ...
    host: {
      describe: request => ok(request, {
        version: '0.0.0-fixture', cwd: '/tmp/fixture', attachedSessions, home: FIXTURE_HOME, canOpenPath: true, canRevealPath: true,
      }),
      ...
      revealPath: request => ok(request, { opened: true as const }),
    },
    workspace: {
