...
export const zh = {
  ...
  'input.attach': '添加文件',
  'file.unsupportedType': '暂不支持该类型文件',
  'file.tooLarge': '文件过大（最大 {size}）',
  'file.readFailed': '文件读取失败',
  'file.parseFailed': '文档解析失败',
  'file.truncated': '内容过长已截断',
  'file.remove': '移除文件 {name}',
  'image.dropTitle': '松开以添加文件',
  'image.dropDesc': '支持图片和文本文件；图片最多 {count} 张，每张 {size}',
...
export const en = {
  ...
  'file.tooLarge': 'File too large ({size} max)',
  'file.readFailed': 'Failed to read file',
  'file.parseFailed': 'Failed to parse document',
  'file.truncated': 'Content too long; truncated',
  'file.remove': 'Remove file {name}',
  'image.dropTitle': 'Drop to add files',
  'image.dropDesc': 'Images and text files supported; up to {count} images, {size} each',
  ...
  'row.failed': 'Failed',
  'row.stopped': 'Stopped',
  'reveal.inFolder': 'Show in folder',
